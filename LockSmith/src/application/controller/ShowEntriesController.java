...
public class ShowEntriesController {
	...
	/**
	 * This method calls Entry class to get the values and set to display on the ShowEntries.fxml
	 * It also uses manages display, layout , adding image to the files 
	 * 
	 */
